package com.browsy.android.repository

import com.browsy.android.api.GoogleBooksApi
import com.browsy.android.api.OpenLibraryApi
import com.browsy.android.api.mappers.GoogleBooksMapper
import com.browsy.android.api.mappers.GoogleBooksMapper.toBook
import com.browsy.android.api.mappers.OpenLibraryMapper
import com.browsy.android.api.mappers.OpenLibraryMapper.toBook
import com.browsy.android.cache.BookCache
...
class BookRepository(
    ...
    /**
     * Swift-compatible overload for searchBooks with orderBy parameter.
     * @param query Search query
     * @param startIndex Start index for pagination
     * @param orderBy Sort order ("newest" or "relevance")
     * @return Result with list of matching books
     */
    suspend fun searchBooks(query: String, startIndex: Int, orderBy: String): Result<List<Book>> {
        return searchBooks(query, startIndex, orderBy as String?)
    }
